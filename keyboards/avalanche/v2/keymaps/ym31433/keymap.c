...
/*
qmk compile -kb avalanche/v2 -km ym31433
qmk flash -kb avalanche/v2 -km ym31433
*/
...
#define BSPC_RALT RALT_T(KC_BSPC)
    ...
    [LAYER_0] = LAYOUT(
        ...
        KC_LGUI, KC_LSFT, KC_A,    KC_S,    KC_D,    KC_F,    KC_G,    XXXXXXX, XXXXXXX, KC_H,    KC_J,    KC_K,    KC_L,    KC_SCLN, KC_QUOT, KC_RBRC,
                 KC_LCTL, KC_Z,    KC_X,    KC_C,    KC_V,    KC_B,    KC_DEL,  KC_BSPC, KC_N,    KC_M,    KC_COMM, KC_DOT,  KC_SLSH, KC_RCTL,
                                   KC_MUTE, KC_GRV,  LFN_3,   FN_2,    EN_LALT, BSPC_RALT, FN_1,    RFN_3,   FN_3,    KC_LSCR
    ),
    [LAYER_1] = LAYOUT(
